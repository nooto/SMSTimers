...
typedef NSUInteger CGDataXMLNodeKind;

@interface CGDataXMLNode : NSObject <NSCopying> {
@protected
...
+ (CGDataXMLElement *)elementWithName:(NSString *)name URI:(NSString *)value;
...
@interface CGDataXMLElement :CGDataXMLNode
...
- (CGDataXMLNode *)attributeForLocalName:(NSString *)name URI:(NSString *)attributeURI;
...
@interface CGDataXMLDocument : NSObject {
@protected
